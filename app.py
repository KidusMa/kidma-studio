                    ...
                    if st.button("Create Packshot"):
                        with st.spinner("Creating professional packshot..."):
                            try:
                                ...
                                if force_rmbg:
                                    # Try to import remove_background from services if available
                                    try:
                                        from services import remove_background
                                    except ImportError:
                                        st.error("Background removal service is not available.")
                                        return
